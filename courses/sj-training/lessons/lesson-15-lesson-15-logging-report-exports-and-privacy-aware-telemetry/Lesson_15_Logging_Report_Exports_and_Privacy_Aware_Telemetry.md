# Lesson 15 - Logging, Report Exports, and Privacy-Aware Telemetry
...
- Decide what tool activity should be logged.
- Create useful logs without collecting sensitive project information unnecessarily.
- Use exports to support model QA and adoption feedback.
...
- Which checks produce the most issues?
...
- Personal user data beyond what your organisation approves

## Suggested Log Row

```markdown
| Date | Tool | Version | Revit | Result | Processed | Warnings | Errors |
```

## Report Export Pattern

Use reports for outputs users need to act on:

```text
reports/
â”œâ”€â”€ 2026-08-08_model_intelligence.md
â””â”€â”€ 2026-08-08_sheet_qa.csv
```

## Exercise

Add a lightweight privacy-aware run summary to your tool output. Optional: export a Markdown report.
