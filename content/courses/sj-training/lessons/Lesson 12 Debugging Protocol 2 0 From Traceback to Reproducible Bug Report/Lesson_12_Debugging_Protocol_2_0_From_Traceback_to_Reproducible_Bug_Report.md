# Lesson 12 - Debugging Protocol 2.0: From Traceback to Reproducible Bug Report
...
- Create a proper debugging workflow for pyRevit tools.
- Capture enough context for AI or another developer to help.
- Turn bugs into tests and documentation.

## Debugging Is Evidence Collection

Do not ask AI to fix a tool until you can describe the failure.
...
## Model Context
Sample / Live / Detached / Workshared / ACC
...
Temporary debug prints are fine. Production debug noise is not.
...
Create one deliberate bug in a copy of your tool, capture the traceback, and write a complete bug report.
